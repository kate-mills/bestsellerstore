        ...
        <div className="section section-center page">
          ...
          <div className="product-center">
            ...
            >
              <h2
                className={`${
                  isLongName ? 'long-name product-name' : 'product-name'
                }`}
              >
                {name}
              </h2>
              ...
              <p className="product-skintypes info">
                {skinTypeBadge ? (
                  skinTypeBadge.map((type, id) => {
                    return (
                      <span key={id} className="skintype">
                        {type}
                      </span>
                    )
                  })
              ...
              <p className="product-company">
                Brand: <span>Michele Corley Clinical Skincare</span>
              </p>
              <p className="info award">
                <span>
                  {award && `Dermascope Aestheticians Choice Award - ${award}`}
                </span>
              </p>
              <hr />
              ...
              <AddToCart
                ...
                priceMap={priceMap ? priceMap : null}
              />
            </section>
          </div>
        </div>
